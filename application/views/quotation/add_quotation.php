...
<section class="panel">
    ...
    <div class="panel-body">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="sandbox">
                        ...
                        <select class="form-control" name="company_id" required>
                            <option value="AL">CHOISIR UNE ENTREPRISE</option>
             ...
             <div class="row">
                 <div class="col-md-4">
                     <label for="select-beast">Matière:</label>
                     <input type="text" name="invoice_no" class="form-control">
                 </div>
                 <div class="col-md-4">
                     <label for="select-beast">Projet:</label>
                     <input type="text" name="payment" class="form-control">
                 </div>
             </div>
        <div class="row">
            <div class="col-md-6 col-md-offset-2">
                <label for="select-beast">Détails du sujet:</label>
                        ...
                        <table id="" class="table table-bordered table-striped table-nowrap dataTable" cellspacing="0" width="100%">
                            ...
                            <tr>
                                <td style="text-align:right;" colspan="3">
                                    <strong style="color: inherit;">Remise totale:</strong>
                                </td>
                                <td class="text-right">
                            ...
                            <tr>
                                <td style="text-align:right;" colspan="3">
                                    <strong style="color: inherit;">TVA:</strong>
                                </td>
                                <td class="text-right">
                            ...
                            <tr>
                                ...
                                <td colspan="3" style="text-align:right;">
                                    <strong style="color: inherit;">Somme Finale:</strong>
                                </td>
                                <td class="text-right">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="box">
                                        <div class="box-header">
                                            <h3 class="box-title">termes et conditions
