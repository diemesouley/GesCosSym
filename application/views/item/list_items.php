        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body modal-edit">
                    ...
                    <div class='form-group'>
                        <label for='inputPassword1' class='col-lg-3 col-sm-3 control-label'>TAILLE</label>
                    ...
                    <div class='form-group'>
                        <label for='inputPassword1' class='col-lg-3 col-sm-3 control-label'>Taux D'Achat</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class='form-group'>
                    <label for='inputPassword1' class='col-lg-3 col-sm-3 control-label'>TAUX DE STOCK</label>
