...
<head>
    ...
    <title>SYM - Panneau d'Administration</title>
            ...
            <div class="panel-body">
               <form method="post" action="get_catItems">
                ...
                <select data-error="Category is required or need attention." required="required" data-placeholder="Select Category" id="category" class="tip chzn-select span4" name="category">
                    ...
                    <option value="6">zubehör pratique</option>
                </select>
               <input type="submit" name="submit" class="btn btn-primary">
                   <a href="<?=base_url();?>item/list_items" class="btn btn-danger">Retour</a>
               </form>
                <!--<div class="row">
...
<button title="" class="btn btn-primary btn-block tip no-print" onclick="window.print('get_print');return false;" type="button" data-original-title="Print"><i class="icon fa fa-print"></i> Imprimer</button>
