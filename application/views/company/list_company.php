        ...
        <div class="box light bordered">
            <div class="box-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase">Liste d'entreprises </span>
                    |
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class='form-group'>
                        <label for='inputEmail1' class='col-lg-3 col-sm-3 control-label'>ENTREPRISE
                            Nom</label>
                        <div class='col-lg-9'>
...
<div class="modal fade" id="basic" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title">Ajouter Entreprise</h4>
            </div>
            <?php $attributes = array('class' => 'form-horizontal group-border hover-stripped', 'id' => 'myform', 'method' => 'post');
            ...
            <div class="modal-body">
                ...
                <div class='form-group'>
                    <label for='inputEmail1' class='col-lg-3 col-sm-3 control-label'>Nom
                        Entreprise</label>
                    <div class='col-lg-9'>
