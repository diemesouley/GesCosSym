                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <?php echo form_open('', array('id' => 'edit_company', 'method' => 'post', 'class' => 'form-horizontal form')); ?>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" style="width: 20%;" for="email">Numéro Tel: </label>
                                <div class="col-sm-9">
                                    <div class="input-group">
                                          <span class="input-group-addon">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label" style="width: 20%;" for="address">Site Web Url</label>
                                <div class="col-sm-9">
                                    <div class="input-group">
                                          <span class="input-group-addon">
                                                <span class="icon icon-globe"></span>
                                          </span>
                                        <input class="form-control" type="text"  name="website" value="<?=$company_info['website'];?>" id="website" placeholder="https://www.diemesouley@gmail.com.com">
                                    </div>
                                </div>
                            </div>
