    ...
    <div style="left: 50%; transform: translateX(-50%);" class="col-md-8">
        <div class="box">
            <div class="box-header">
                <strong><span class="icon icon-dollar"></span> CHANGER DE DEVISE</strong>
            </div>
            <div class="box-body">
                <div id="msg"></div>
                <?php echo form_open('#', array('id' => 'update_currency', 'method' => 'post', 'class' => 'form-horizontal form')); ?>
                <div class="form-group">
                    <label class="col-sm-3 control-label" style="width: 20%;" for="name">Devise par défaut</label>
                    <div class="col-sm-9">
                ...
                <div class="form-group">
                    <label for="username" class="col-sm-3 control-label" style="width: 20%;"
                           for="form-control-17">Sélectionnez la devise</label>
                    <div class="col-sm-9">
                ...
                <div class="col-xs-6 col-md-3">
                    <button class="btn btn-primary" style="margin-left: 250px;padding: 6px 25px;"
...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <strong>Gérer les devises</strong>
            </div>
            <div class="box-body">
