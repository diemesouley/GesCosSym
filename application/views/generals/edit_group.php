          ...
          <div class="panel-body">
            <div class=" form">
                ...
                <div class="form-group ">
                  <label for="cname" class="control-label col-lg-3">Nom du groupe (obligatoire)</label>
                ...
                <div class="form-group">
                  <div class="col-lg-offset-3 col-lg-6">
                    ...
                    <a href="<?=base_url();?>generals/add_group" class="btn btn-default" type="button">Fermer</a>
                  </div>
                </div>
              <?php form_close();?>
            </div>
