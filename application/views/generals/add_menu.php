        ...
        <section class="box box-danger">
            ...
            <div class="box-body">
                <div id="error" style="display:none;" class="alert alert-error alert-block fade in">
                    ...
                    <strong>L'enregistrement existe déjà</strong>
                </div>
                <div id="success" style="display:none;" class="alert alert-success alert-block fade in">
                    <button class="close" data-dismiss="alert">×</button>
                    <strong>Enregistrement ajouté avec succès</strong>
                </div>
                ...
                <div class=" form">
                        ...
                        <div class="form-group ">
                            <label for="cname" class="control-label col-lg-3">Nom du menu (obligatoire)</label>
                        ...
                        <div class="form-group ">
                            <label for="cname" class="control-label col-lg-3">URL du menu (obligatoire)</label>
                        ...
                        <div class="form-group ">
                            <label for="cname" class="control-label col-lg-3">Ordre de tri</label>
                        ...
                        <div class="form-group">
                            <label for="cname" class="control-label col-lg-3">Menu Parent </label>

                            <div class="col-lg-6">
                                <select class="form-control input-lg m-bot15" name="parent" id="PARENT_ID">
                                    <option value="0">Sélectionnez le menu parent</option>
