...
<div class="row">
    <div class="col-md-12 col-lg-12 col-sm-12">
        <div class="box light bordered">
            <div class="box-title">
                <h4>CATÉGORIES | <a href='#myModal-1' data-toggle='modal' class='btn btn-info'>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn green">Sauvegarder les modifications</button>
                </div>
                </form>
            </div>
            <!-- /.modal-content -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class='form-group'>
                    <label for='inputEmail1' class='col-lg-4 col-sm-3 control-label'>NOM DE CATÉGORIE</label>
                    <div class='col-lg-8'>
