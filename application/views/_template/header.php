                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="<?=base_url('users/change_password')?>" class="btn btn-default btn-flat">Changer MotdePAss</a>
                                </div>
                                <div class="pull-right">
                                    <a href="<?=base_url('users/logout')?>" class="btn btn-default btn-flat">Déconexion</a>
                                </div>
                            </li>
                        </ul>
                    </li>
