...
<head>
  ...
  <title>Diemesouley GesCos | Page d'inscription</title>
...
<div class="register-box">
  <div class="register-logo">
    <a href="<?=base_url();?>assets/index2.html"><b>GesCos</b>SYM</a>
  </div>
  ...
  <div class="register-box-body">
   ...
   <?php form_close();?>
    ...
    <a href="<?=base_url('users/login')?>" class="text-center">J'ai déjà un abonnement</a>
  </div>
  <!-- /.form-box -->
</div>
<!-- /.register-box -->
