...
<head>
    ...
    <title>DIEMESOULEY | Connexion</title>
...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <div class="form-group has-feedback">
            <input type="text" class="form-control" name="u_email" placeholder="Utilisateur">
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
            <input type="password" class="form-control" name="u_password" autocomplete="off" placeholder="Mot de Pass">
        ...
        <a href="<?= base_url('users/register') ?>" class="text-center">Enregistrer une nouvelle adhésion</a>
        <hr>
        <p><strong>Contactez:</strong> Souleymane | <strong>DIEME:</strong> 771208795</p>
    </div>
    <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
