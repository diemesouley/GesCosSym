<div class="row">
    <div class="col-md-12">
        ...
        <div class="box light bordered">
            <div class="box-title">
                <h4><i class="icon-reorder"></i> Rapport d'Achat </h4>
						<span class="tools">
                    ...
                    <div class="row ">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <main class="invoice_report">
                                ...
                                <h4>Rapport d'achat de: <strong><?= $start; ?></strong> Au <strong><?= $end; ?></strong>
                                </h4>
                                <br>
                                <br>
                                <?php $total = '';
                                ...
                                foreach ($purchases as $rows): ?>
                                    <table>
                                        <thead>
                                        <tr>
                                            <th class="no text-right"><strong>PUR-771208795</strong></th>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tfoot>
                                        <tr>
                                            <td align="center" colspan="3"><b>Somme Total</b></td>
                            ...
                            <footer class="text-center">
                                <strong>SYM TECH</strong>&nbsp;&nbsp;&nbsp;Dkr-0300, Dkr300 Pvt Ltd, Deans Ventre Produit,
                                Cosmetique
                            </footer>
