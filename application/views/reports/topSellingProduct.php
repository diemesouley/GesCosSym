        ...
        <div class="box box-primary">
            <div class="box-header box-header-background with-border">
                <div class="col-md-offset-3">
                    <h3 class="box-title ">Produit le plus vendu</h3>
                </div>
            </div>
            <!-- /.box-header -->
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 col-md-offset-3">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Date de Début<span class="required" aria-required="true"> *</span></label>
                                ...
                                <div class="form-group">
                                    <label class="control-label">Date de Fin<span class="required" aria-required="true"> *</span></label>
                                    <div class="input-group">
                                ...
                                <button type="submit" class="btn bg-navy">Générer un rapport                                    </button><br><br>
                            </div>
                            <!-- /.box-body -->
                ...
                <div id="printableArea">
                    ...
                    <div class="row ">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <span><strong>Date de Début:</strong> 01 Oct 2016 <strong>Date de Fin:</strong> 12 Oct 2016</span>
                                ...
                                <div class="table-responsive">
                                    <table width="100%" class="table table-bordered" border="0" cellspacing="0" cellpadding="5">
                                        <tbody><tr>
                                            ...
                                            <td class="active" width="12%"><strong>Code Produit</strong></td>
                                            <td class="active" width="24%"><strong>Nom du Produit</strong></td>
                                            <td class="active" width="12%" align="right"><strong>Quantité de vente</strong></td>
                                            <td class="active" width="12%" align="right"><strong>Valeur d'achat</strong></td>
                                            <td class="active" width="12%" align="right"><strong>Valeur de vente</strong></td>
