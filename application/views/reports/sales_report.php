                    ...
                    <div class="row ">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <main class="invoice_report">
                                ...
                                <h4>Rapport des ventes de: <strong><?php echo $start ?></strong> Au
                                ...
                                <?php if (!empty($invoice_details)) : ?>
                                    <table>
                                        ...
                                        <tr style="background-color: #ccc">
                                            <th class="no text-left">Coût total</th>
                                            <th class="no text-left">Vente totale</th>
                                            <th class="no text-left">Bénéfice total</th>
                                        </tr>
                                        </thead>
                                ...
                                <?php else: ?>
                                    <strong>Il n'y a pas d'enregistrement pour l'affichage</strong>
                                <?php endif ?>
