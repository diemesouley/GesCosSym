            ...
            <div class="adv-table editable-table table-responsive">
                <div class="clearfix">
                    ...
                    <div class="col-md-6" style="border-right: 1px solid #ccc;">
                        ...
                        <div class="sandbox">
                            <label for="select-beast">Nom du fournisseur:</label>
                    ...
                    <div class="col-md-6">
                        <div class="sandbox">
                            <label for="select-beast">Nom de la compagnie:</label>
...
<!--<form role="form" method="post" action="<?= base_url(); ?>index.php/purchase/insert_purchase">-->
    ...
    <section class="panel" style="display:none">
        ...
        <div class="alert alert-warning" id="wrong" style="display: none;">
            <p>Veuillez sélectionner l'un d'eux</p>
        </div>
        <div class="panel-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="payment_method" class="form-control" data-parsley-id="8750">
                                        ...
                                        <option value="1">En espèces</option>
                ...
                <div id="print">
                    ...
                    <div id="">
                        <table style="width:100%; float:right; padding:5px; color:#000; background: #FFF;" id="">
                            <tbody>
                            <tr>
                                <td style="padding: 5px 10px;border-top: 1px solid #DDD;">Articles</td>
                            ...
                            <tr>
                                <td style="padding: 5px 10px;">Taxe de commande <a id="pptax2" href="#" tabindex="-1">
                                ...
                                <td style="padding: 5px 10px;">Remise <a id="ppdiscount" href="#" tabindex="-1">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                </td>
                            ...
                            <div class="row">
                                ...
                                <div style="padding: 0;" class="col-xs-4">
                                    <button style="height:67px;" id="payment" class="btn btn-success btn-block"
                                        ...
                                        <i style="margin-right: 5px;" class="fa fa-money"></i>Paiement
                                    </button>
                                </div>
                            </div>
                        </div>
